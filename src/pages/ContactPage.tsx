          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row gap-10">
                ...
                <div className="bg-[#151528] p-8 rounded-lg border border-white/10 h-full shadow-lg">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white/70 mt-1">msialia.dev@gmail.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white/70 mt-1">0917-123-4567</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white/70 mt-1">Cavite, Philippines</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-10">
                    ...
                    <div className="flex space-x-4">
                      <a href="#" className="bg-[#1E1E3F] p-3 rounded-lg text-white/60 hover:text-[#B83280] transition-colors shadow-md hover:shadow-lg transition-shadow duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                        </svg>
                      </a>
                      <a href="#" className="bg-[#1E1E3F] p-3 rounded-lg text-white/60 hover:text-[#D53F8C] transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
              ...
              <motion.div 
                ...
                className="md:w-3/5"
              >
                <form onSubmit={handleSubmit} className="bg-[#151528] p-8 rounded-lg border border-white/10 shadow-lg">
                  <h3 className="text-white text-xl font-medium mb-6">Send me a message</h3>
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1E1E3F] border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-[#B83280] shadow-inner"
                      required
                    />
                  </div>
                  ...
                  <button type="submit" className="w-full bg-[#B83280] text-white py-3 rounded-lg font-medium hover:bg-[#97266D] transition-colors shadow-lg hover:shadow-xl transition-shadow duration-300">
                    Send Message
                  </button>
                </form>
              </motion.div>
